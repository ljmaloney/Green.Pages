            ...
            <table role="presentation" style="width: 100%; max-width: 800px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow: hidden;">
                ...
                <tr>
                    <td style="padding: 40px;">
                        ...
                        <p style="font-size: 14px; color: #6b7280; line-height: 1.4;">
                            Thank you for listing your business with us. We attempted to charge your credit card on file for the
                            monthly amount of $${invoiceTotal?string["#,##0.00"]}. Unfortunately, there was a problem with processing
                            the monthly subscription amount. The subscription will cancel in 30 days without any further action from you. Or you
                            can log in to the dashboard and update or change your credit card information.
                            <br/>
