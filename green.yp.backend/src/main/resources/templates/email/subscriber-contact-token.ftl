            ...
            <table role="presentation" style="width: 100%; max-width: 800px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow: hidden;">
                ...
                <tr>
                    <td style="padding: 40px;">
                        ...
                        <br/><br/>
                        <p style="font-size: 14px; color: #6b7280; line-height: 1.4;">
                            The subscriber contact was created from ip address ${ipAddress} at ${timestamp}.
                        </p>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <div style="margin-bottom: 24px;">
                                        <a href="https://greenyp.com/subscribers" style="display: inline-block; background-color: #16a34a; color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 12px 24px; border-radius: 6px; border: none;">
