...
public abstract class AbstractImageFileService implements ImageFileService {
  ...
  public void deleteImage(UUID producerId, String overrideBase, String imageFilename) {
    String pathString =
        createFileKeyPath(
            getBasePath(urlBasePath, overrideBase), producerId, imageGalleryPath, null);
  ...
  protected abstract String saveImageFile(
      MultipartFile multipartFile, String pathString, String fileName);
