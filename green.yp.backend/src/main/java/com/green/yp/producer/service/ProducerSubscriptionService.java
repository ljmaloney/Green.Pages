...
public class ProducerSubscriptionService {
  ...
  public ProducerSubscriptionService(
  ...
  private void upgradePaidSubscription(
      Producer producer,
      UUID subscriptionId,
  ...
  private void updateUnpaidSubscription(
      Producer producer, InvoiceCycleType invoiceCycleType, SubscriptionDto subscriptionDto) {
  ...
  public void paymentFailedCancellation(
