...
public class ProducerContact extends Mutable {
  ...
  public boolean equals(Object o) {
    ...
    return new EqualsBuilder()
        ...
        .append(producerContactType, that.producerContactType)
        .append(displayContactType, that.displayContactType)
        .append(genericContactName, that.genericContactName)
        .append(firstName, that.firstName)
        .append(lastName, that.lastName)
        .append(title, that.title)
        .append(phoneNumber, that.phoneNumber)
        .append(cellPhoneNumber, that.cellPhoneNumber)
        .append(emailConfirmed, that.emailConfirmed)
        .append(authenticationCancelDate, that.authenticationCancelDate)
        .append(emailConfirmedDate, that.emailConfirmedDate)
        .append(emailConfirmationToken, that.emailConfirmationToken)
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 37)
        ...
        .append(producerContactType)
        .append(displayContactType)
        .append(genericContactName)
        .append(firstName)
        .append(lastName)
        .append(title)
        .append(phoneNumber)
        .append(cellPhoneNumber)
        .append(emailConfirmed)
        .append(authenticationCancelDate)
        .append(emailConfirmedDate)
        .append(emailConfirmationToken)
        .append(emailAddress)
        .toHashCode();
  }
}
