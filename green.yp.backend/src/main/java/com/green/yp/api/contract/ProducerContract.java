...
public class ProducerContract {
    ...
    public ProducerContract(ProducerOrchestrationService producerService, ProducerLocationService producerLocationService, ProducerUserService producerUserService) {
    ...
    public ProducerCredentialsResponse updateMasterCredentials(UserCredentialsRequest masterUserCredentials,
                                                               UUID producerId,
                                                               UUID credentialsId,
                                                               String ipAddress) throws NoSuchAlgorithmException {
        return producerUserService.updateUserCredentials(masterUserCredentials, producerId, credentialsId, ipAddress);
    }

    public ProducerCredentialsResponse replaceMasterUserCredentials(UUID producerId,
                                                                    UUID credentialsId,
                                                                    UserCredentialsRequest masterUserCredentials,
                                                                    String ipAddress) throws NoSuchAlgorithmException {
        return producerUserService.replaceMasterUserCredentials(masterUserCredentials, producerId, ipAddress);
    }

    public List<ProducerResponse> findLastModified(Integer daysOld,
