...
public class ClassifiedController {
    ...
    public ResponseApi<ClassifiedResponse> findClassified(@PathVariable("classifiedId") UUID classifiedId){
    ...
    public ResponseApi<ClassifiedResponse> createClassified(@RequestBody @Valid ClassifiedRequest classifiedRequest){
